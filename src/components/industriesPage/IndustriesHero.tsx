    ...
    <section className="relative w-full h-[60vh] min-h-[480px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="px-4 md:px-8 text-white max-w-3xl relative z-10">
        ...
        >
          ...
          />
          Serving Diverse Industries Across the UAE
        </motion.div>
        ...
        >
          From food cargo to automobiles, industrial machinery, and personal goods — our expertise ensures smooth, compliant clearance in Dubai and across the UAE.
        </motion.p>
