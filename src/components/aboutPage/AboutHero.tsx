...
import HeroBg from "@/assets/background-image2.webp";
    ...
    <section className="relative w-full h-[60vh] min-h-[480px] flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="px-4 md:px-8 text-white max-w-3xl relative z-10">
        ...
        >
          ...
          />
          Trusted Customs & Logistics Partner Since Day One
        </motion.div>
        ...
        >
          Simplifying customs clearance and logistics across Dubai and all UAE borders for businesses and individuals.
        </motion.p>
