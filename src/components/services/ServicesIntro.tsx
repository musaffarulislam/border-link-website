      ...
      <div className="container mx-auto px-4 md:px-8 text-center">
        ...
        >
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-12 font-inter max-w-2xl mx-auto">
            Border Link Cargo & Customs Broker LLC specializes in seamless
            customs clearance and end-to-end logistics solutions. Our
            experienced team ensures your shipments are processed efficiently
            and comply with all UAE regulations.
          </p>
        </motion.div>
          ...
          {services.map((service, idx) => {
            ...
            return (
              <motion.div key={idx} variants={cardVariants}>
                <Link
                  href={service.href}
                  className="group block relative rounded-xl p-6 shadow-lg bg-primary cursor-pointer hover:shadow-2xl transform hover:-translate-y-2 transition h-full"
                >
                  {/* Icon */}
